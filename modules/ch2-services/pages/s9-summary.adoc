...
* All interactions with an OpenStack cluster start with Keystone, which provides authentication and service discovery for all other services. Keystone also organizes API resources in domains and projects for the separation of concerns.
